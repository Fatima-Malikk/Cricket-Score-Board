...
{ 
    ...
    int totalovers2=0;
    char tmnm2[100];
    int subchoice1,subchoice2;
	char tmnm1[100];
	
	
	int i,j,c,c1,n,date, year;
 ...
 printf("Enter the name of team 1 and team 2\n");
 scanf("%s %s",tmnm1,tmnm2);
 printf("\t\t\t\t%s VS %s\n",tmnm1,tmnm2);
 printf("\t===============================================================\n");
...
target=totalruns1+1;
printf("\t===============================================================\n");
printf("\t\t\t\t TARGET is %d in 20 OVERS",target);
printf("\t===============================================================\n");
...
{
	printf("\t===============================================================\n");
	printf("\t\t\t%s WON THE MATCH",tmnm1);
	printf("\t===============================================================\n");
}
else if(totalruns2>target)
{
	printf("\t===============================================================\n");
	printf("\t\t\t%s WON THE MATCH",tmnm2);
	printf("\t===============================================================\n");
}
